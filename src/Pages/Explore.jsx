...
function Explore() {
  ...
  const filteredProperties = properties.filter(property => {
    return (
      ...
      (!filters.availability || property.available.toString() === filters.availability)
    );
  });
      ...
      <div className="filter-bar">
        ...
        <div className="filters">
          ...
          <div className="rent-filter">
            <select name="minRent" value={filters.minRent} onChange={handleFilterChange}>
              <option value="">Min Rent</option>
              <option value="4000">₹4000</option>
              <option value="5000">₹5000</option>
              <option value="6000">₹6000</option>
            </select>
            <select name="maxRent" value={filters.maxRent} onChange={handleFilterChange}>
